...
public class LatticeDoor extends DoorBlock {
	public LatticeDoor(Properties properties) {
		super(properties);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader world, List<ITextComponent> tooltip, ITooltipFlag flag) {
		tooltip.add(text("Solid door, used in sewers or canals."));
		tooltip.add(text("Sometimes in storages or public dumpsters."));
	}
}
